...
export default function CommunityAlertsScreen() {
  ...
  const communityAlerts = [
    // New North-Eastern India disaster-management alerts (prepended)
    {
      id: 1001,
      type: 'harassment',
      title: 'Landslide reported near Tawang – road temporarily closed',
      description: 'Authorities advise avoiding the Tawang-Bomdila route due to debris on roads.',
    ...
    },
    {
      id: 1002,
      type: 'unsafe_area',
      title: 'Flash flood warning in Imphal East – avoid low-lying areas',
      description: 'Heavy rainfall expected; local administration urges caution in flood-prone zones.',
    ...
    },
    {
      id: 1003,
      type: 'suspicious',
      title: 'Earthquake tremor felt in Shillong, no damage reported',
      description: 'Light tremors recorded by locals; authorities monitoring the situation.',
    ...
    },
    {
      id: 1004,
      type: 'unsafe_area',
      title: 'Heavy snowfall causing roadblocks on NH-10 (Gangtok)',
      description: 'Snow accumulation reported at multiple bends; travel only if essential.',
      location: 'NH-10, near Gangtok, Sikkim',
      distance: '—',
      time: '2 hours ago',
      reporter: 'Anonymous',
      upvotes: 5,
    ...
    },
    {
      id: 1005,
      type: 'harassment',
      title: 'Cyclone warning issued for coastal Assam region',
      description: 'High winds and heavy rainfall expected; secure belongings and stay indoors.',
      location: 'Coastal Assam (Brahmaputra valley)',
      distance: '—',
      time: '3 hours ago',
      reporter: 'Anonymous',
      upvotes: 14,
